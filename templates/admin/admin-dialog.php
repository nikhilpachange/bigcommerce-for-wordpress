	...
	<div class="bc-shortcode-ui__products-wrapper">
		...
		<section class="bc-shortcode-ui__products" data-js="bc-shortcode-ui-products">
			<div class="bc-shortcode-ui__search">
				...
				>
					<label for="bcqb-input" class="screen-reader-text">
						<?php esc_html_e('Search for products', 'bigcommerce'); ?>
					</label>
					<input id="bcqb-input"
						   type="text"
						   ...
						   data-js="bcqb-input"
					>
					<button type="button" class="bc-shortcode-ui-search__submit-button" data-js="bcqb-submit">
						<?php esc_html_e('Search', 'bigcommerce'); ?>
					</button>
					<button type="button" class="bc-shortcode-ui-search__clear-search" data-js="bcqb-clear">
						<?php esc_html_e('(Clear Search)', 'bigcommerce'); ?>
					</button>
				</form>
			</div>
